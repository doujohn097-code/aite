...
import cn from 'clsx';
import { AiteLogo } from './aite-logo';
...
function AiteIcon({ className }: IconProps): JSX.Element {
  return <AiteLogo className={className} />;
}
...
function MessengerIcon({ className, solid }: IconProps): JSX.Element {
  return (
    <svg
      className={cn(
        solid ? 'fill-current' : 'fill-none stroke-current',
        className
      )}
      strokeWidth={solid ? undefined : 40}
      viewBox='0 0 640 640'
      aria-hidden='true'
    >
...
function HouseIcon({ className, solid }: IconProps): JSX.Element {
  return (
    <svg
      className={cn(
        solid ? 'fill-current' : 'fill-none stroke-current',
...
function ClapperboardIcon({ className, solid }: IconProps): JSX.Element {
  return (
    <svg
      className={cn(
        solid ? 'fill-current' : 'fill-none stroke-current',
      ...
      strokeWidth={solid ? undefined : 9}
      viewBox='0 0 122.14 122.88'
      aria-hidden='true'
    >
      {/* scaled down so it visually matches the outline icons around it */}
      <g transform='translate(12.21 12.29) scale(0.8)'>
